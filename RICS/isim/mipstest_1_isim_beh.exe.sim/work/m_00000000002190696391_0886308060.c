...
#endif
static const char *ng0 = "D:/RICS/ALU.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {2, 0};
static int ng4[] = {3, 0};
...
LAB20:    t422 = (t0 + 4312);
    ...
    *((unsigned int *)t432) = (t434 | t428);
    xsi_driver_vfirst_trans(t422, 0, 15);
    t435 = (t0 + 4216);
    *((int *)t435) = 1;
...
LAB144:    if (*((unsigned int *)t336) > 0)
        goto LAB145;

LAB146:    memcpy(t335, t376, 8);
...
LAB152:    if (*((unsigned int *)t367) < *((unsigned int *)t368))
        goto LAB150;

LAB151:    goto LAB140;

LAB141:    t378 = (t0 + 1528U);
    t379 = *((char **)t378);
    t378 = ((char*)((ng9)));
    memset(t380, 0, 8);
    t381 = (t379 + 4);
...
LAB154:    *((unsigned int *)t380) = 1;

LAB156:    memset(t377, 0, 8);
    t396 = (t380 + 4);
...
LAB164:    if (*((unsigned int *)t403) > 0)
        goto LAB165;

LAB166:    if (*((unsigned int *)t377) > 0)
        goto LAB167;

LAB168:    memcpy(t376, t413, 8);

LAB169:    goto LAB142;

LAB143:    xsi_vlog_unsigned_bit_combine(t335, 32, t369, 32, t376, 32);
    goto LAB147;

LAB145:    memcpy(t335, t369, 8);
    goto LAB147;
...
LAB161:    t407 = (t0 + 1688U);
    t408 = *((char **)t407);
    goto LAB162;

LAB163:    t407 = (t0 + 1848U);
    t414 = *((char **)t407);
    memset(t413, 0, 8);
    t407 = (t413 + 4);
    t415 = (t414 + 4);
    ...
    *((unsigned int *)t413) = t417;
    ...
    t419 = (t418 >> 16);
    *((unsigned int *)t407) = t419;
    t420 = *((unsigned int *)t413);
    *((unsigned int *)t413) = (t420 & 65535U);
    t421 = *((unsigned int *)t407);
    *((unsigned int *)t407) = (t421 & 65535U);
    goto LAB164;

LAB165:    xsi_vlog_unsigned_bit_combine(t376, 32, t408, 32, t413, 32);
    goto LAB169;

LAB167:    memcpy(t376, t408, 8);
    goto LAB169;
...
extern void work_m_00000000002190696391_0886308060_init()
{
	static char *pe[] = {(void *)Cont_74_0,(void *)Cont_83_1};
	xsi_register_didat("work_m_00000000002190696391_0886308060", "isim/mipstest_1_isim_beh.exe.sim/work/m_00000000002190696391_0886308060.didat");
